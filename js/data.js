...
const PRODUCTS = [
  ...
  { id: "hd09", name: "Flame-Effect Ultrasonic Humidifier & Diffuser", cat: "Home Décor", room: "Home Décor", price: 90.10, memberPrice: 85.75, sku: "DM-10111", tag: "New", ph: "", img: "assets/products/hd09.png",
    ...
    desc: "Set the mood with the gentle flicker of a flame, without the flame. This ultrasonic humidifier and essential-oil diffuser projects a remarkably realistic dancing flame light while releasing a fine, whisper-quiet mist that softens dry air and carries your favourite oils through the room. A calming centrepiece for the living room, bedroom, office, yoga studio or gym, with simple touch timers and an auto shut-off when the water runs low. Add a few drops of oil, dim the lights, and unwind.",
    features: [
      "Realistic flame-effect mood light, ambience without an open flame",
      "Whisper-quiet ultrasonic mist humidifies dry air and diffuses essential oils",
      "Touch timer: 1, 3 or 5 hours, with auto shut-off when the tank is empty",
      "Compact, considered design for living rooms, bedrooms, offices, studios & gyms",
      "Available in White or Black"
    ],
    specs: { "Type": "Humidifier / aroma diffuser", "Feature": "Flame-effect light", "Timer": "1 / 3 / 5 hours", "Operation": "Ultrasonic, noise-free" },
    care: "Empty and wipe dry after each use. Clean the tank periodically with a soft, damp cloth; avoid harsh chemicals or submerging the base." },
